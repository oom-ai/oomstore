...
oomcli import \
    --group phone \
    --table-link "offline_batch_snapshot_1_2" \
    --description 'linked table' > /dev/null
expected='
ID,REVISION,GROUP,SNAPSHOT-TABLE,CDC-TABLE,DESCRIPTION
1,0,phone,offline_batch_snapshot_1_1,
2,1639047117470,phone,offline_batch_snapshot_1_2,,test data
3,1639047117552,phone,offline_batch_snapshot_1_2,,linked table
'
