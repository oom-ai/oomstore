...
// Source: /Users/jinghan/source/jinghancc/oom-ai/oomstore/internal/database/metadatav2/store.go
...
func (m *MockStore) CreateRevision(ctx context.Context, opt metadatav2.CreateRevisionOpt) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetRevision(ctx context.Context, opt metadatav2.GetRevisionOpt) (*types.Revision, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListRevision(ctx context.Context, opt metadatav2.ListRevisionOpt) ([]*types.Revision, error) {
	m.ctrl.T.Helper()
