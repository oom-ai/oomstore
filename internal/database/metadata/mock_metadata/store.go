...
// Source: oom-ai/oomstore/internal/database/metadata/store.go
...
func (mr *MockReadStoreMockRecorder) GetEntityByName(ctx, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntityByName", reflect.TypeOf((*MockReadStore)(nil).GetEntityByName), ctx, name)
}
...
// ListEntity indicates an expected call of ListEntity.
func (mr *MockReadStoreMockRecorder) ListEntity(ctx, entityIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntity", reflect.TypeOf((*MockReadStore)(nil).ListEntity), ctx, entityIDs)
}

// ListFeature mocks base method.
func (m *MockReadStore) ListFeature(ctx context.Context, opt metadata.ListFeatureOpt) (types.FeatureList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListFeature", ctx, opt)
	ret0, _ := ret[0].(types.FeatureList)
	ret1, _ := ret[1].(error)
