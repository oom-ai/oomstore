...
def online_get(entity_key, feature_names):
...
if __name__ == "__main__":
    print(online_get("1006", ["state", "credit_score", "account_age_days", "has_2fa_installed", "transaction_count_7d", "transaction_count_30d"]))
